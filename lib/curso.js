...
// --- TIPO de contenido por ruta (la distincion que pidio Jose) ---
// Cada ruta se nombra distinto y algunas son practicas DIARIAS.
export const TIPO_RUTA = {
  biocuantico: { etiqueta: "Activación", diaria: true },
  biohacking: { etiqueta: "Práctica", diaria: true },
  mindfulness: { etiqueta: "Podcast", diaria: true },
  neurociencias: { etiqueta: "Clase", diaria: false },
  comunicacion: { etiqueta: "Ruta", diaria: false }, // el PDF de Drive
};

// Devuelve el tipo de una clase segun su ruta (con respaldo).
export function tipoDeClase(clase) {
  return TIPO_RUTA[clase.ruta] || { etiqueta: "Clase", diaria: false };
}
